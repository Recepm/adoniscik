...
.setColor(AloneDogru)
.setTitle("Adonis |  Karıştır")
.setDescription(`<a:hypesquad:765831981568622602> | Müzik Kuyruğu, ${message.author} tarafından karıştırıldı.`) 
...
.setTitle("• Hata: 009 •")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`<a:hypesquad:765831981568622602> | Müzik kuyruğunu karıştırabilmek için bir ses kanalında olmanız gerekmektedir!`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL());  
