...
.setDescription(`<a:hypesquad:765831981568622602>  | Oynatılan bir müziği duraklatabilmek için bir ses kanalında olmanız gerekmektedir!`)
...
.setColor(AloneDogru)
.setTitle("Adonis |   Duraklat")
.setDescription(`<a:hypesquad:765831981568622602>   | \`${sarki.name}\` adlı müzik ${message.author} tarafından duraklatıldı!`) 
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL())
