...
.setDescription(`<a:hypesquad:765831981568622602> | Şu anda çalan müziği görebilmek için bir ses kanalında olmanız gerekmektedir!`)
...
.setColor("#0affff")
.setDescription(`<a:hypesquad:765831981568622602>  | Şu Anda Oynatılan:\n\nMüziğin Adı: \n\`${calan.name}\`\n\nMüziği Yükleyen Kanal: \n\`${calan.author}\` \n\nMüziğin Linki: \n[Youtube'den dinlemek için tıkla!](${calan.url})`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL())
