...
.setDescription(`<a:hypesquad:765831981568622602>  | Oynatılan bir müziği devam ettirebilmek için bir ses kanalında olmanız gerekmektedir!`)
...
.setColor(AloneDogru)
.setTitle("Adonis | Devam Et")
.setDescription(`<a:hypesquad:765831981568622602> | \`${sarki.name}\` adlı müzik ${message.author} tarafından devam ettirildi!`) 
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL())
